...
class NavTest():
    def __init__(self):
        ...
        trans = self.frametrans('', 'map')
        locations['green'] = Pose(Point(trans.Translation.x, trans.Translation.y, 0.0), Quaternion(0.0, 0.0, trans.Rotation.z, 0.0))
    ...
    def frametrans(self, current_frame, target_frame):
        ...
        trans = tfBuffer.lookup_transform(target_frame, current_frame, rospy.Time())
        return trans
