...
def callback(message):
   ...
   #print("Message: %s, Sent at: %s, Received at: %s"%(message.data,rospy.get_time(),rospy.get_time()))
   print("Message: %s, Sent at: %f, Received at: %f"%(message.my_string,message.time_stamp,rospy.get_time()))
...
def listener():
    ...
    rospy.Subscriber("chatter_talk", TimestampString, callback)
